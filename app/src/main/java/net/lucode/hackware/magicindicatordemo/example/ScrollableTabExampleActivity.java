...
import com.hsicen.magicindicator.indicators.BezierPagerIndicator;
...
import com.hsicen.magicindicator.indicators.WrapPagerIndicator;
...
public class ScrollableTabExampleActivity extends AppCompatActivity {
    ...
    private void initMagicIndicator3() {
        ...
        magicIndicator.setBackgroundColor(Color.parseColor("#FF0F0F10"));
        CommonNavigator commonNavigator = new CommonNavigator(this);
        commonNavigator.setAdapter(new CommonNavigatorAdapter() {
            ...
            public IPagerTitleView getTitleView(Context context, final int index) {
                ...
                simplePagerTitleView.setNormalColor(Color.parseColor("#FF656367"));
                simplePagerTitleView.setSelectedColor(Color.parseColor("#FFA47AE2"));
                simplePagerTitleView.setText(mDataList.get(index));
            ...
            public IPagerIndicator getIndicator(Context context) {
                ...
                linePagerIndicator.setColors(Color.parseColor("#FFA47AE2"));
